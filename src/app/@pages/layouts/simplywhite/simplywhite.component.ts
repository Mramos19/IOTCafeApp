...
export class SimplyWhiteLayout extends RootLayout implements OnInit, AfterViewInit {
 ...
 public _UserEntities: UserEntities = {};
  ...
  ngOnInit() {
    ...
    this.authenticationService.GetMenu().then(_Response => {

      console.log(_Response);

      this.menuLinks = _Response;
    ...
    this.authenticationService.GetUser().then(_Response => {

      console.log(_Response);

      if (_Response.statusCode === "00") {
        this._UserEntities.userName = _Response.result.userName;
      }
  ...
  LogOut() {
    ...
    this.authenticationService.RemoveMenu();
